	   ...
	   <!-- <header class="d-flex flex-wrap justify-content-between py-2 mb-0">-->
		...
		<div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
	      <ul class="navbar-nav ml-auto">
	        ...
	        <li class="nav-item">
	          <a class="nav-link mx-2" href="/viewInventory">Update Auto Part</a>
	        </li>
	        <li class="nav-item">
		...
		<br><h2 class="heading my-2 py-2"><b><u>Update Auto part</u></b></h2><br>
		<table class="table table-secondary" style="width:90%;margin:auto">
