	   ...
	   <!-- <header class="d-flex flex-wrap justify-content-between py-2 mb-0">-->
		...
		<div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
	      <ul class="navbar-nav ml-auto">
	        ...
	        <li class="nav-item">
	          <a class="nav-link mx-2" href="/groceries">Auto Parts</a>
	        </li>
	        <li class="nav-item">
		...
		<div>
			...
			<br><h2><b><u>Auto Parts</u></b></h2><br>
		...
		<c:if test="${username ne null}">
				<a class="text-dark" href="addGroceries"><h5>Add Groceries</h5></a>
		</c:if>
		<br> -->
	</body>
</html>