...
<!-- Background image -->
  	<div class="container align-items-center p-4">
		...
		<h4>Admin Conrols : </h4> <br>
		<div class="d-grid gap-0 col-12 mx-auto">
			<c:if test="${username ne null}">
				<a href="viewOrders"><button type ="button" class="btn btn-dark btn-rounded">View Orders</button></a><br><br>
				<a href="adminGroceries"><button type ="button" class="btn btn-dark btn-rounded">View Auto Parts</button></a><br><br>
				<a href="viewInventory"><button type ="button" class="btn btn-dark btn-rounded">Update Auto Part</button></a><br><br>
				<a href="viewCustomers"><button type ="button" class="btn btn-dark btn-rounded">View Customers</button></a><br><br>
				<a href="addGroceries"><button type ="button" class="btn btn-dark btn-rounded">Add Auto Part</button></a><br><br>
			</c:if>
			</div>
		</div>	
	</body>
