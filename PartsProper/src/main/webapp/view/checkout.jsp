	   ...
	   <!-- <header class="d-flex flex-wrap justify-content-between py-2 mb-0">-->
		...
		<div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
	      <ul class="navbar-nav ml-auto">
	        ...
	        <li class="nav-item">
	          <a class="nav-link mx-2" href="/checkout">My Orders</a>
	        </li>
	        <li class="nav-item">
	          <a class="nav-link mx-2" href="/groceries">Back To Auto Parts</a>
	        </li>
	        <li class="nav-item">
		...
		<h1 class="heading my-2 py-2"><b><u>My Orders</u></b></h1>
		<br>
